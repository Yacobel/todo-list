      ...
      <div class="saidbare">
        <ul>
          ...
          <li>
            ...
            <a class="text-ul" href="suspand.php">suspend tasks</a>
          </li>
        </ul>
        <ul>
              ...
              <div class="form">
                    ...
                    <div class="form-info">
                      <label for="">
                        ...
                        <h3>Task</h3> <input type="text" name="name" value="' . htmlspecialchars($el['name']) . '">
                      </label>
                      <label for="">
                        <h3>Start Date</h3> <input type="datetime-local" name="start" value="' . $el['start'] . '">
                      </label>
                      <label for="">
                        <h3>End Date</h3> <input type="datetime-local" name="end" value="' . htmlspecialchars($el['end']) . '">
                      </label>
                      <label for="">
